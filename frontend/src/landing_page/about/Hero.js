...
function Hero(){
    return (
        <div className='hero-about'>
            <div><h1 className='head-hero-about'>We pioneered the discount broking model in India.</h1>
                <h1>Now, we are breaking ground with our technology.</h1>
                <hr /></div>
            <div className='desc-hero-about'>
                <div className='desc-left-hero-about'>
                ...
                <div className='desc-right-hero-about'>
